...
class AuthController {
    constructor() {
        ...
        this.validateToken = (request, response) => __awaiter(this, void 0, void 0, function* () {
            const { body } = request;
            const { accessToken } = body;
            try {
                const payload = jsonwebtoken_1.default.verify(accessToken, passport_1.jwtOptions.secretOrKey);
                // @ts-ignore
                const user = yield this.authService.get(payload.id);
